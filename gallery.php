...
<div id="mySidenav" class="sidenav">
  ...
  <p> <a href="https://instagram.com/shravan.y?utm_medium=copy_link" target="__blank"> <i class="fa fa-instagram mr-1" aria-hidden="true"></i> INSTAGRAM </a> </p>
        ...
        <div class="row main">
            ...
            <div id="carouselExampleControls" class="carousel slide col-md-12 p-0" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="data">
                        <h1  data-aos-duration="5000" data-aos ="fade-down"> Gallery </h1>
    ...
    <div class="container-fluid gallery-section gallery-page p-4 ">
            <h1 class="text-center mb-5 mt-5"> Gallery </h1>
            <div class="gallery2 row " id="gdata">
            
            </div>
        <div class="col-md-4 offset-md-4 mt-5 text-center">
            <input type="button" class="btn btn-outline-primary btn-normal" id="showMore" onClick="pagination()" value="Show More">
        </div>
    </div>
